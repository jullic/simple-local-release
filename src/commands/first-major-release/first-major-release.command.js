...
exports.FirstMajorReleaseCommand = void 0;
const abstract_command_1 = require("../abstract/abstract.command");
class FirstMajorReleaseCommand extends abstract_command_1.AbstractCommand {
    load(program) {
        return program
...
exports.FirstMajorReleaseCommand = FirstMajorReleaseCommand;
