...
exports.getCommitsBetweenPoints = void 0;
...
const getCommitsBetweenPoints = (point1, point2) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { data } = yield (0, spawn_1.asyncSpawnShellByPlatform)([`git log ${point1}..${point2}`]);
...
exports.getCommitsBetweenPoints = getCommitsBetweenPoints;
